...
INSERT INTO platform.translations (locale, namespace, key, value) VALUES
    ...
    -- Dev Plugin Loader panel
    ('hu', 'plugin-manager', 'devPlugins.loader.title', 'Fejlesztői plugin betöltése'),
    ('en', 'plugin-manager', 'devPlugins.loader.title', 'Load Development Plugin'),
    ('hu', 'plugin-manager', 'devPlugins.loader.description', 'Tölts be egy plugint a helyi fejlesztői szerverről'),
    ('en', 'plugin-manager', 'devPlugins.loader.description', 'Load a plugin from your local development server'),
    ('hu', 'plugin-manager', 'devPlugins.loader.urlPlaceholder', 'http://localhost:5174'),
    ('en', 'plugin-manager', 'devPlugins.loader.urlPlaceholder', 'http://localhost:5174'),
    ('hu', 'plugin-manager', 'devPlugins.loader.load', 'Betöltés'),
    ('en', 'plugin-manager', 'devPlugins.loader.load', 'Load'),
    ('hu', 'plugin-manager', 'devPlugins.loader.loading', 'Betöltés...'),
    ('en', 'plugin-manager', 'devPlugins.loader.loading', 'Loading...'),
    ('hu', 'plugin-manager', 'devPlugins.loader.step1', 'Buildeld a plugint:'),
    ('en', 'plugin-manager', 'devPlugins.loader.step1', 'Build the plugin:'),
    ('hu', 'plugin-manager', 'devPlugins.loader.step2', 'Indítsd el a dev szervert:'),
    ('en', 'plugin-manager', 'devPlugins.loader.step2', 'Start the dev server:'),
    ('hu', 'plugin-manager', 'devPlugins.loader.step3', 'Add meg a szerver URL-jét és kattints a Betöltés gombra.'),
    ('en', 'plugin-manager', 'devPlugins.loader.step3', 'Enter the server URL and click Load.'),
    ('hu', 'plugin-manager', 'devPlugins.loader.dockerHint', 'Docker-ben futó app esetén használd a {host} címet a localhost helyett.'),
    ('en', 'plugin-manager', 'devPlugins.loader.dockerHint', 'If the app runs in Docker, use {host} instead of localhost.'),
    ('hu', 'plugin-manager', 'devPlugins.loader.loadedSuccess', 'Plugin "{name}" betöltve'),
    ('en', 'plugin-manager', 'devPlugins.loader.loadedSuccess', 'Plugin "{name}" loaded'),
    ('hu', 'plugin-manager', 'devPlugins.loader.updatedSuccess', 'Plugin "{name}" frissítve'),
    ('en', 'plugin-manager', 'devPlugins.loader.updatedSuccess', 'Plugin "{name}" updated'),

    -- Update page
    ('hu', 'plugin-manager', 'update.modalTitle', 'Alkalmazás frissítése'),
    ('en', 'plugin-manager', 'update.modalTitle', 'Update App'),
    ('hu', 'plugin-manager', 'update.selectTitle', 'Frissítési csomag kiválasztása'),
    ('en', 'plugin-manager', 'update.selectTitle', 'Select Update Package'),
    ('hu', 'plugin-manager', 'update.selectDescription', 'Töltsön fel egy újabb verziójú csomagot a(z) {pluginName} ({currentVersion}) frissítéséhez'),
    ('en', 'plugin-manager', 'update.selectDescription', 'Upload a newer version package to update {pluginName} ({currentVersion})'),
    ('hu', 'plugin-manager', 'update.dragDropLabel', 'Húzza ide a frissítési csomagot vagy kattintson a tallózáshoz'),
    ('en', 'plugin-manager', 'update.dragDropLabel', 'Drag and drop update package or click to browse'),
    ('hu', 'plugin-manager', 'update.dragDropText', 'Húzza ide a frissítési csomagot'),
    ('en', 'plugin-manager', 'update.dragDropText', 'Drag & drop your update package here'),
    ('hu', 'plugin-manager', 'update.acceptedFormats', 'Elfogadott formátumok: {formats} — max. {maxSize} MB'),
    ('en', 'plugin-manager', 'update.acceptedFormats', 'Accepted formats: {formats} — max. {maxSize} MB'),
    ('hu', 'plugin-manager', 'update.browseFiles', 'Fájl tallózása'),
    ('en', 'plugin-manager', 'update.browseFiles', 'Browse Files'),
    ('hu', 'plugin-manager', 'update.previewTitle', 'Frissítés megerősítése'),
    ('en', 'plugin-manager', 'update.previewTitle', 'Confirm Update'),
    ('hu', 'plugin-manager', 'update.previewDescription', 'Ellenőrizze a frissítési adatokat, majd kattintson a Frissítés megerősítése gombra'),
    ('en', 'plugin-manager', 'update.previewDescription', 'Review the update details and click Confirm Update to proceed'),
    ('hu', 'plugin-manager', 'update.preview.pluginName', 'Alkalmazás neve'),
    ('en', 'plugin-manager', 'update.preview.pluginName', 'App Name'),
    ('hu', 'plugin-manager', 'update.preview.currentVersion', 'Jelenlegi verzió'),
    ('en', 'plugin-manager', 'update.preview.currentVersion', 'Current Version'),
    ('hu', 'plugin-manager', 'update.preview.newVersion', 'Új verzió'),
    ('en', 'plugin-manager', 'update.preview.newVersion', 'New Version'),
    ('hu', 'plugin-manager', 'update.preview.selectedFile', 'Kiválasztott fájl'),
    ('en', 'plugin-manager', 'update.preview.selectedFile', 'Selected File'),
    ('hu', 'plugin-manager', 'update.preview.fileSize', 'Fájlméret'),
    ('en', 'plugin-manager', 'update.preview.fileSize', 'File Size'),
    ('hu', 'plugin-manager', 'update.confirmButton', 'Frissítés megerősítése'),
    ('en', 'plugin-manager', 'update.confirmButton', 'Confirm Update'),
    ('hu', 'plugin-manager', 'update.backButton', 'Vissza'),
    ('en', 'plugin-manager', 'update.backButton', 'Back'),
    ('hu', 'plugin-manager', 'update.updating', 'Frissítés folyamatban...'),
    ('en', 'plugin-manager', 'update.updating', 'Updating...'),
    ('hu', 'plugin-manager', 'update.updatingHint', 'Ez eltarthat néhány másodpercig. Kérem, ne zárja be az ablakot.'),
    ('en', 'plugin-manager', 'update.updatingHint', 'This may take a few seconds. Please do not close the window.'),
    ('hu', 'plugin-manager', 'update.successMessage', 'Alkalmazás sikeresen frissítve: {oldVersion} → {newVersion}'),
    ('en', 'plugin-manager', 'update.successMessage', 'App updated successfully: {oldVersion} → {newVersion}'),

    -- Update errors
    ('hu', 'plugin-manager', 'update.errors.invalidExtension', 'Csak {extensions} fájlok engedélyezettek'),
    ('en', 'plugin-manager', 'update.errors.invalidExtension', 'Only {extensions} files are allowed'),
    ('hu', 'plugin-manager', 'update.errors.fileTooLarge', 'A fájl mérete meghaladja a {maxSize} MB limitet ({actualSize} MB)'),
    ('en', 'plugin-manager', 'update.errors.fileTooLarge', 'File size exceeds {maxSize} MB limit ({actualSize} MB)'),
    ('hu', 'plugin-manager', 'update.errors.updateFailed', 'A frissítés sikertelen. Kérem, próbálja újra.'),
    ('en', 'plugin-manager', 'update.errors.updateFailed', 'Update failed. Please try again.'),
    ('hu', 'plugin-manager', 'update.errors.networkError', 'Hálózati hiba. Ellenőrizze a kapcsolatot és próbálja újra.'),
    ('en', 'plugin-manager', 'update.errors.networkError', 'Network error. Please check your connection and try again.'),

    -- Detail update button
    ('hu', 'plugin-manager', 'detail.update', 'Frissítés'),
    ('en', 'plugin-manager', 'detail.update', 'Update'),
