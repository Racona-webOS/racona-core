<!--
  RaccoonHead.svelte — Threlte alapú 3D animált avatar GLB modellből.

  A head3d.glb modellt tölti be és animálja érzelem-állapotok szerint.
...
>
	<Canvas>
		<T.PerspectiveCamera makeDefault position={[0, 0, 1.8]} fov={55} />
